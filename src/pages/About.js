...
const About = () => {
  return (
    <Layout>
      ...
      >
        <Typography variant="h4"><h2 style={{color:'red',textDecoration:'none',fontFamily:'sun-arial',letterSpacing:'3px'}}>Welcome To My Resturant</h2> </Typography><br></br>
        ...
        <p>
          ...
          aperiam unde? <br></br>At veritatis nesciunt eos quas cupiditate blanditiis est
        ...
        <br></br>
        <br></br>
          <img src={aboutimg} height={600} width={1275} style={{paddingBottom:'0px'}}></img>
      </Box>
    </Layout>
  );
};
